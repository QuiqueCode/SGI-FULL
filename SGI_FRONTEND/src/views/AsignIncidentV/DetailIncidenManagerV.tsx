        ...
        <div className="bodyContainer7">
              ...
              <IonSelect
                ...
                onIonChange={(e) =>
                  handleStatue({
                    ...
                    CT_CEDULA_USUARIO: valueToken,
                    CN_ESTADO_ACTUAL: detail?.CN_ID_ESTADOF || 0,
                  })
                }
          ...
          <div className="icon-text">
            ...
            <div>
              ...
              >
                {risk.map((data, index) => (
                  <IonSelectOption key={index} value={data.CN_ID_RIESGO}>
                    {data.CT_DESCRIPCION}
                  </IonSelectOption>
                ))}
              </IonSelect>
            ...
            <div>
              ...
              >
                {priority.map((data, index) => (
                  <IonSelectOption key={index} value={data.CN_ID_PRIORIDAD}>
                    {data.CT_DESCRIPCION}
                  </IonSelectOption>
                ))}
              </IonSelect>
            ...
            <div>
              ...
              >
                {affectation.map((data, index) => (
                  <IonSelectOption key={index} value={data.CN_ID_AFECTACION}>
                    {data.CT_DESCRIPCION}
                  </IonSelectOption>
                ))}
              </IonSelect>
            ...
            <div>
              ...
              >
                {category.map((data, index) => (
                  <IonSelectOption key={index} value={data.CN_ID_CATEGORIA}>
                    {data.CT_DESCRIPCION}
                  </IonSelectOption>
                ))}
              </IonSelect>
